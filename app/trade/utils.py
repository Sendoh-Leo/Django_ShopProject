...
"""
Crypto提供了各种各样的加密算法。
Crypto 算法库在 python 中最初叫 pycrypto，这个作者有点懒， 好几年没有更新， 后来就有大佬写了个替代库 pycryptodome。
支持的加密算法有： 常见对称密码在 Crypto.Cipher 库下，主要有：DES 3DES AES RC4 Salsa20
...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        ...
        alipay_public_key_path="./keys/ali_key.txt",
    ...
    data=alipay.direct_pay(
        # 订单标题
        subject="Aomega电商平台-商品订单",
        # 我们商户自行生成的订单号
        out_trade_no="20180419westos",
        # 订单金额
        total_amount=999,
